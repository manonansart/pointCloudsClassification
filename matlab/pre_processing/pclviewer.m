...
function pclviewer(points, args)
    ...
    %viewer = '/home/guerrero/pcl_programming/pcl_visualizer/build/pcl_visualizer'; 
   % viewer = 'c:\Program Files (x86)\PCL_1_6_0\bin'; 
    %pointfile = [tempname '.pcd']
    pointfile = 'temp_cloud.pcd';
    if nargin < 2
        args = '';
    end
