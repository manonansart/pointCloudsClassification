...
main (int argc, char** argv)
{
  ...
  pcl::SpinImageEstimation<pcl::PointXYZ, pcl::Normal, pcl::Histogram<153> > spin_image_descriptor(8, 0.5, 0);
  spin_image_descriptor.setInputCloud (basic_cloud_ptr);
  spin_image_descriptor.setInputNormals (cloud_normals1);
